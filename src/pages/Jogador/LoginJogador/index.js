...
export default function LoginJogador({ navigation, route }){
    const [email, setEmail] = useState()
    const [senha, setSenha] = useState()
    const [errorLogin, setErrorLogin] = useState("")

    const {loginFirebaseJogador} = useContext(AuthContext);

    const {signInWithGoogleAsyncJogador} = useContext(AuthContext);
    ...
    return(
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
            <View style={styles.viewTitle1}>
                <Text style={styles.title1}>Olá Jogador!</Text>
            ...
            <FormButton
                buttonTitle="Entrar"
                onPress={() => loginFirebaseJogador(email, senha)}
            />            
            }
            ...
            onPress={()=> navigation.navigate("Cadastrar Jogador")}
            >
                Quero me Cadastrar!
            </Text>
            </Text>
            ...
            {Platform.OS === 'android' ? (
                ...
                <SocialButton
                    ...
                    onPress={() => signInWithGoogleAsyncJogador()}
                />
                </View>
            ) : null}   
            </ScrollView>
